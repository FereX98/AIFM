...
GenericConcurrentHopscotchLocal::GenericConcurrentHopscotchLocal(
...
void GenericConcurrentHopscotchLocal::forward_get(uint8_t key_len,
                                             const uint8_t *key,
...
bool GenericConcurrentHopscotchLocal::_put(uint8_t key_len, const uint8_t *key,
...
bool GenericConcurrentHopscotchLocal::_remove(uint8_t key_len, const uint8_t *key) {
